...
router.get('/fileUploads', (req, res, next) => {
  FileUpload.find()
    ...
    .then(fileUploads => res.status(200).json({ fileUpload: fileUploads }))
...
router.patch('/fileUploads/:id', removeBlanks, (req, res, next) => {
...
router.delete('/fileUploads/:id', (req, res, next) => {
  FileUpload.findById(req.params.id)
    .then(handle404)
    .then(fileUpload => {
